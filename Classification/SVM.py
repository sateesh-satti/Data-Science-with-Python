...
#   The key objective of SVM is to draw a hyperplane that separates the two classes optimally such
# that the margin is maximum between the hyperplane and the observations.

# If the SVM has more than one hyperplanes then the objective of
# SVM is to find the one which gives us a high margin.

# SVM is comparatively less prone to outliers than logistic regression as it only
